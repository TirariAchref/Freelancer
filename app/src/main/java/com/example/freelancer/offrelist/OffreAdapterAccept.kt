...
import com.example.freelancer.OffreDetailsAccept
import com.example.freelancer.R
import com.example.freelancer.models.Offre
import com.example.freelancer.utils.ApiInterface

class OffreAdapterAccept (val QuestionList: MutableList<Offre>) : RecyclerView.Adapter<OffreViewHolder>() {
    ...
    override fun onBindViewHolder(holder: OffreViewHolder, position: Int) {
        ...
        var Status= QuestionList[position].Status
        var idAccept= QuestionList[position].UserIdAccept
        ...
        holder.itemView.setOnClickListener{ v ->
            ...
            val intent = Intent(v.context, OffreDetailsAccept::class.java)
